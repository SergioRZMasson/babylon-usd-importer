...
const root = resolve(process.env.ROOT ?? fileURLToPath(new URL('../../docs', import.meta.url)));
...
server.listen(port, () => {
    console.log(`\n  Babylon USD Importer demo -> http://localhost:${port}`);
